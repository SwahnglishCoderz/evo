...
class Config
{
    ...
    const APP = [
        ...
        "database" => [
            ...
            "drivers" => [
                "mysql" => [
                    "class" => "\\Evo\\DataObjectLayer\\Drivers\\MysqlDatabaseConnection"
                ],
                "pgsql" => [
                    "class" => "\\Evo\\DataObjectLayer\\Drivers\\PgsqlDatabaseConnection"
                ],
                "sqlite" => [
                    "class" => "\\Evo\\DataObjectLayer\\Drivers\\SqliteDatabaseConnection"
                ]
            ]
        ],
        "debug_error" => [
